...
export function MangaCard({
    ...
    const isNew = (() => {
        const updatedAt = new Date(manga.updatedAt).getTime();
        const now = Date.now();
        const twentyFourHours = 24 * 60 * 60 * 1000;
        return now - updatedAt < twentyFourHours;
    })();
    ...
    return (
        ...
        >
            ...
            >
                ...
                {isNew && (
                    <span className="badge-new absolute top-2 left-2 z-20 inline-block rounded-md px-2 py-0.5 text-[10px] font-extrabold uppercase tracking-wider text-white">
                        New Chapter
                    </span>
                )}
            </div>
