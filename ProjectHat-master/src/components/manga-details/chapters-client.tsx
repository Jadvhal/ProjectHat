        ...
        <div className="relative md:-top-11 md:pointer-events-none md:-mb-11">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4 mb-4 pointer-events-auto">
                {currentChapters?.map((chapter) => (
                    ...
                    >
                        <Card
                            className={`h-full transition-colors p-0 ${chapter.id === lastRead
                            ...
                            <CardContent className="p-4">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    {Date.now() -
                                        ...
                                        24 * 60 * 60 * 1000 && (
                                            <span className="badge-new shrink-0 inline-block rounded-md px-1.5 py-0.5 text-[9px] font-extrabold uppercase tracking-wider text-white">
                                                New
                                            </span>
                                        )}
                                </div>
